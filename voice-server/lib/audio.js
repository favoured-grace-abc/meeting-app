// Audio processing utilities for the Whisper pipeline
...
// Simple audio feature extraction for diarization
// Extracts RMS energy and zero-crossing rate from raw PCM data
...
// Simple Voice Activity Detection - returns segments of audio that contain speech
...
// Extract a PCM segment from a buffer given start/end times
export function extractPcmSegment(pcmBuffer, startSec, endSec, sampleRate = 16000) {
  const startSample = Math.floor(startSec * sampleRate) * 2; // 2 bytes per sample
